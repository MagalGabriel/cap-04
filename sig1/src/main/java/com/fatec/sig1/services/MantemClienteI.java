...
/**
 * * A classe mantem cliente implementa o padrao Service. Servce eh um padrao
 * que basicamente encapsula * o processo de obtencao de serviços(objetos). O
 * Service cria uma camada de abstracao neste * processo. Ao inves da classe
 * dependente instanciar suas dependencias diretamente, eles são * solicitados a
 * partir de um objeto centralizado que atua como localizador de serviços.
 * * @author *
 */
@Service
